...
describe('WordleBoard', () => {
  ...
  describe('Rules for defining the word of the day', () => {
    ...
    ])("Since $reason: $wordOfTheDay is invalid, therefore a warning must be emitted", async ({ wordOfTheDay, reason }) => {
